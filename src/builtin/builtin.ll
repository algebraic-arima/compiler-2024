...
define dso_local noalias ptr @toString(i32 noundef %0) local_unnamed_addr #2 {
  %2 = tail call dereferenceable_or_null(16) ptr @malloc(i32 noundef 16) #10
...
define dso_local noalias nonnull ptr @array..malloc(i32 noundef %0) local_unnamed_addr #7 {
  %2 = shl i32 %0, 2
  %3 = add i32 %2, 4
...
define dso_local noalias ptr @..malloc(i32 noundef %0) local_unnamed_addr #8 {
  %2 = shl nsw i32 %0, 2
