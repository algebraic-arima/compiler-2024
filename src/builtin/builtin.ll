...
define dso_local ptr @getString() local_unnamed_addr #2 {
  %1 = tail call dereferenceable_or_null(256) ptr @malloc(i32 noundef 256) #9
...
define dso_local noalias ptr @toString(i32 noundef %0) local_unnamed_addr #2 {
  %2 = tail call dereferenceable_or_null(16) ptr @malloc(i32 noundef 16) #9
...
define dso_local ptr @string.substring(ptr noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  ...
  %8 = tail call ptr @memcpy(ptr noundef %6, ptr noundef %7, i32 noundef %4) #8
...
define dso_local ptr @string.add(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  %8 = tail call ptr @memcpy(ptr noundef %7, ptr noundef %0, i32 noundef %3) #8
  %9 = getelementptr inbounds i8, ptr %7, i32 %3
  %10 = tail call ptr @memcpy(ptr noundef %9, ptr noundef %1, i32 noundef %4) #8
...
define dso_local noalias ptr @_malloc(i32 noundef %0) local_unnamed_addr #7 {
  %2 = shl nsw i32 %0, 2
  %3 = tail call ptr @malloc(i32 noundef %2) #9
  ret ptr %3
}
...
attributes #8 = { nobuiltin nounwind "no-builtin-memcpy" "no-builtin-printf" }
attributes #9 = { allocsize(0) "no-builtin-memcpy" "no-builtin-printf" }
